SELECT     dbo.uvw_FIC_SSELP_PCTAS01.ROW_ID, dbo.uvw_FIC_SSELP_PCTAS01.UPD_ID, dbo.uvw_FIC_SSELP_PCTAS01.GRP_ID, 
                      ...
                      dbo.uvw_FIC_SSELP_PCTAS01.[Clave Especial], dbo.uvw_FIC_SSELP_PCTAS01.[Dirección E-Mail], 
                      dbo.uvw_FIC_SSELP_PCTAS01.[Fecha Alta], 
                      dbo.uvw_FIC_SSELP_PCTAS01.[Crédito Máximo],  dbo.PCTAV.IVA, 
                      dbo.PCTAV.Vendedor
FROM         dbo.uvw_FIC_SSELP_PCTAS01 INNER JOIN
                      dbo.PCTAV ON dbo.uvw_FIC_SSELP_PCTAS01.GRP_ID = dbo.PCTAV.GRP_ID AND dbo.uvw_FIC_SSELP_PCTAS01.Código = dbo.PCTAV.Codigo