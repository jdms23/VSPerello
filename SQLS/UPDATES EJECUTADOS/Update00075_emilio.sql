...
/****** Object:  View [dbo].[vr_prepeal]    Script Date: 02/09/2012 16:27:17 ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dbo].vf_estad_ventas_lineas
with encryption
AS
SELECT     dbo.eje_venta_c.empresa, dbo.eje_venta_c.ejercicio, dbo.eje_venta_c.codigo_tipo_documento, dbo.eje_venta_c.serie, dbo.eje_venta_c.numero, 
                      ...
                      dbo.emp_formas_pago.descripcion AS descripcion_forma_pago, dbo.eje_venta_l.codigo_Articulo, dbo.emp_articulos.descripcion, dbo.eje_venta_l.unidades, 
...
CREATE VIEW [dbo].[vf_estad_ventas_cabecera]
with encryption
AS
SELECT     dbo.eje_venta_c.empresa, dbo.eje_venta_c.ejercicio, dbo.eje_venta_c.codigo_tipo_documento, dbo.eje_venta_c.serie, dbo.eje_venta_c.numero, 
