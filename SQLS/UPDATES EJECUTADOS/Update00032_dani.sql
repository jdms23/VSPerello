...
ALTER TABLE gen_empresas ADD registro_mercantil dm_char_largo
...
SELECT     dbo.eje_venta_c.empresa, dbo.eje_venta_c.ejercicio, dbo.eje_venta_c.codigo_tipo_documento, dbo.eje_venta_c.serie, dbo.eje_venta_c.numero, 
                      ...
                      dbo.eje_factura_c.telefono_dir_pago, dbo.eje_factura_c.movil_dir_pago, dbo.eje_factura_c.email_dir_pago, dbo.eje_factura_c.fax_dir_pago,eje_venta_c.identificador_dir_envio,
                      calba.serie as serie_albaran,calba.numero as numero_alba,calba.fecha as fecha_albaran,eje_venta_c.clave_entidad_banco,eje_venta_c.clave_sucursal_banco,eje_venta_c.digito_control_banco,eje_venta_c.cuenta_corriente_banco,eje_venta_c.criterio_conjuntacion,
                      emp_clientes.criterio_facturacion1,emp_clientes.criterio_facturacion2,emp_clientes.criterio_facturacion3,
                      gen_empresas.nombre as nombre_empresa, gen_empresas.razon_social as razon_social_empresa, gen_empresas.domicilio as domicilio_empresa,
                      gen_empresas.codigo_postal as codigo_postal_empresa, gen_empresas.poblacion as poblacion_empresa, gen_empresas.provincia as provincia_empresa,
                      gen_empresas.telefono as telefono_empresa,gen_empresas.fax as fax_empresa,gen_empresas.registro_mercantil as registro_mercantil_empresa
FROM         dbo.eje_venta_c LEFT OUTER JOIN
                      ...
                      dbo.eje_venta_l.numero = dbo.eje_factura_l.numero and dbo.eje_venta_l.linea = dbo.eje_factura_l.linea LEFT JOIN
